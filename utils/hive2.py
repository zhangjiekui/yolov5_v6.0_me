...
dht = hivemind.DHT(initial_peers= ['/ip4/127.0.0.1/tcp/41893/p2p/QmRQcKTZbfUnhJ4sbmAzchqHHZs2CurV9vs2gH2rocQSX5'], start=True)
# dht = hivemind.DHT(initial_peers=['/ip4/127.0.0.1/tcp/COPY_FULL_ADDRESS_FROM_PEER1_OUTPUTS'], start=True)

#  ['/ip4/127.0.0.1/tcp/36225/p2p/QmPm3ssLcNXe7mvn4wvwbAYK1ttGvieNPRUT24qFNzw3eY']
