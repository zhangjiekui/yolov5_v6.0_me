# -*- coding: utf-8 -*-
# @Time : 2021/11/24 1:02
# @Author : zjk
# @File : translations_using_nn_transformers.py
# @Project : YOLOX
# @IDE :PyCharm
...
def create_mask(src, tgt):
    ...
    return src_mask, tgt_mask,memory_mask, src_padding_mask, tgt_padding_mask
...
def train_epoch(model, optimizer):
    ...
    for src, tgt in train_dataloader:
        ...
        # shape: torch.Size([23, 128, 10838])
        src_mask, tgt_mask, memory_mask, src_padding_mask, tgt_padding_mask = create_mask(src, tgt_input)


        # 原始
        #logits =                  model(src, tgt_input, src_mask, tgt_mask, None, src_padding_mask, tgt_padding_mask, src_padding_mask)
        # logits_with_memory_mask: 全部为False，形状为（tgt_len,src_len）
        # logits = model(src, tgt_input, src_mask, tgt_mask, memory_mask, src_padding_mask, tgt_padding_mask, src_padding_mask)
        # logits_with_src_mask = None
        logits = model(src, tgt_input, None, tgt_mask, None, src_padding_mask, tgt_padding_mask, src_padding_mask)
...
def evaluate(model):
    ...
    for src, tgt in val_dataloader:
        ...
        src_mask, tgt_mask, _, src_padding_mask, tgt_padding_mask = create_mask(src, tgt_input)
...
print(translate(transformer, "Ich mag diesen Roman.")) #我喜欢这本小说
